...
if __name__ == "__main__":
    ...
    config_path = os.path.join(containing_folder, 'lunar_lander_config.yml')
    ...
    plt.title(f"Lunar Lander GSP-RL {network} Agent Baseline")
    plt.xlabel("Episodes")
    plt.ylabel("Score")
    plt.savefig(f'Lunar_Lander_{network}_baseline.png')
